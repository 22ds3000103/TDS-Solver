...
def solve_http_request_question(question, file=None):
    try:
        ...
        params = {"email": "22ds3000103@ds.study.iitm.ac.in"}
...
def solve_github_repo_question(question, file=None):
    return {"answer": "https://raw.githubusercontent.com/22ds3000103/ga1/refs/heads/main/email.json"}
...
def solve_github_pages_question(question, file=None):
    return {"answer": "https://22ds3000103.github.io/VATCHALA/"}
...
def solve_github_action_question(question, file=None):
    return {"answer": "https://github.com/22ds3000103/vat23_github-action-test"}

# Function GA2Q8: Docker image
def solve_docker_image_question(question, file=None):
    return {"answer": "https://hub.docker.com/repository/docker/vatchala/tds-project/general"}
...
def solve_scheduled_github_action(question, file=None):
    return {"answer": "https://github.com/22ds3000103/tdsga4"}
